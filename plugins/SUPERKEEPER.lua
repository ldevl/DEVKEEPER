...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'تــم #قفـــل|🔐|الملصـــقات فــي هــذه المجموعــٰـُٰـٰةة♥️❗️\n🔲♦️Us : @'..msg.from.username..'\n🔲♦️ID : '.. msg.from.id..'\n'
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'تــم #فتـــٰح|🔓|الملصـــقات فــي هــذه المجموعــٰـُٰـٰةة♥️❗️\n🔲♦️Us : @'..msg.from.username..'\n🔲♦️ID : '.. msg.from.id..'\n'
  end
end
...
local function set_rulesmod(msg, data, target)
  ...
  save_data(_config.moderation.data, data)
  return 'القوانيــُٰـن📝تـم وضعهـــا فــي المجموعـــــةة✅♥️'
end
...
local function get_rules(msg, data)
  ...
  if not data[tostring(msg.to.id)][data_cat] then
    return 'القوانيــُٰـن📝لـم يتم وضعهـــا فــي المجموعـــــةة✅♥️'
  end
...
local function demote2(receiver, member_username, user_id)
  ...
  if not data[group]['moderators'][tostring(user_id)] then
     return send_large_msg(receiver, member_username..'بالفعُــُـل تـــم تنزيلٰــه مـن قائمــة 📝 الادمنيــة❤️❗️')
  end
  data[group]['moderators'][tostring(user_id)] = nil
  save_data(_config.moderation.data, data)
  send_large_msg(receiver, member_username..' ✅تـــم تنزيلـك 😿 مـُٰن الادمنيــة لانــك فاشـُـٰل يروحـــي😸❤️')
end
...
function get_message_callback(extra, success, result)
    ...
    elseif get_cmd == "تنزيل اداري" then
        ...
        if result.from.username then
            ...
            text = "[ "..user_id.." ] بالفعـل تـم ☑️ تنزيلك مـن الاداره 🕵🏻 فــي المجموعــة لانـك فاهــي😸❤️"
        end
    ...
    elseif get_cmd == "رفع المدير" then
        ...
        local channel_id = 'channel#id'..result.to.peer_id
            ...
            if result.from.username then
                text = "@"..result.from.username.." [ "..result.from.peer_id.." ]  تــم ☑️ رفعـك المديـر 🕵🏻 فـي المجموعــٰةة يروحـــي  😽❤️  "
            else
   ...
   for k,v in pairs(result) do 
    ...
    if vusername == member or vpeer_id == memberid then 
      ...
      if v.username then 
        ...
        text = "["..v.peer_id.."]  تـــم رفعـــك ☑️ فـي الاداره بــ🤚🏾ــس لا تنحثـل براسٰـٰي 😼♥️" 
    ...
    for k,v in pairs(result) do 
        ...
        elseif memberid and vusername ~= member and vpeer_id ~= memberid then 
            ...
            if group_owner then 
                ...
                text = "["..memberid.."]  تــم ☑️ رفعـك المديــر 🕵🏻 فـي المجموعـــٰةة يروحــي  😽❤️" 
            end 
        end 
    end 
 end 
    ...
    local data = load_data(_config.moderation.data) 
        ...
        if matches[1] == "مدير المجموعه" then 
            ...
            if not group_owner then 
                return "لآ يوجـُـد ✖️ مديــر فـي المجموعــــةة 🌐 الرجـٰاء اعادة التعبئــًٰـه😸❤️" 
            end 
