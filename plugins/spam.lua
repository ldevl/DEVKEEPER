    ...
    if msgs > max_msg then 
     ...
     if msg.to.type == 'chat' or msg.to.type == 'channel' then 
      if username then 
         ...
         send_large_msg(receiver , " عزيــ❣️ـزيْ ممنـــــــوع ❌ التكــرار فـي هـذه المجموعـــــةة 🌐 تم طردك 🗣 بســـبب عدم الالتـــزام بهذا الامـٰٰر♥️❗️ \n\n♥️ معرفــــك : @"..username.."\n\n ❤️ ايديــٰك : "..msg.from.id.."\n\n مطور الســـورس\n  @llX8Xll")
      else 
